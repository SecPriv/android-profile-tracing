...
#
#
timeout ${TIME}s adb -s ${DEVICEID} shell "monkey -p ${APP} -s 20240412 --throttle 1000 --ignore-crashes --kill-process-after-error --ignore-security-exceptions 10000000" || true
adb shell -s ${DEVICEID} 'pgrep monkey | xargs kill' || true
