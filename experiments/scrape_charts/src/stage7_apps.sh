...
./apkeep -d apk-pure -s $SLEEP_DURATION -r $NUM_PAR -c $SAMPLE_APPS $SAMPLE_APKPURE;
./apkeep -d apk-pure -s $SLEEP_DURATION -r $NUM_PAR -c $TOP_APPS $TOP_APKPURE;
./apkeep -d f-droid -s $SLEEP_DURATION -r $NUM_PAR -c $SAMPLE_APPS $SAMPLE_FDROID;
./apkeep -d f-droid -s $SLEEP_DURATION -r $NUM_PAR -c $TOP_APPS $TOP_FDROID;
./apkeep -d google-play -o include_additional_files=true -u $GOOGLE_ACCOUNT -p $GOOGLE_PASSWORD -s $SLEEP_DURATION -r $NUM_PAR -c $SAMPLE_APPS $SAMPLE_GOOGLEPLAY;
./apkeep -d google-play -o include_additional_files=true -u $GOOGLE_ACCOUNT -p $GOOGLE_PASSWORD -s $SLEEP_DURATION -r $NUM_PAR -c $TOP_APPS $TOP_GOOGLEPLAY;
./apkeep -d huawei-app-gallery -s $SLEEP_DURATION -r $NUM_PAR -c $SAMPLE_APPS $SAMPLE_HUAWEI;
./apkeep -d huawei-app-gallery -s $SLEEP_DURATION -r $NUM_PAR -c $TOP_APPS $TOP_HUAWEI;

#./apkeep -a com.mojang.minecraftpe -d google-play -u downloadingprofiles@gmail.com -p $GOOGLE_PASSWORD ./
